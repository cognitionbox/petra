...
public class PGraphTest extends BaseExecutionModesTest {
  ...
  public void testRefGraph() {
    ...
    Z result = (Z) ((io.cognitionbox.petra.lang.PGraphComputer<Z,Z>)getGraphComputer()).computeWithInput(new RefPGraph(),new Z());
  }
  ...
  public void testExtractRefValueGraph() {
    ...
    X result = (X) ((io.cognitionbox.petra.lang.PGraphComputer<X,X>)getGraphComputer()).computeWithInput(new ExtractRefValuePGraph(),new X());
  }
