...
public class UpdateShortTraders extends PCollectionEdge<State, ESGLongShortPair, Trader> {
    {
        type(State.class);
        ...
        pre((esg,trader) ->
                esg.getToLong()!=null &&
                esg.getToShort()!=null &&
                        trader.getDirection()==Direction.SHORT &&
                        !trader.getInstrument().equals(esg.getToShort()));
        func(
                (esg, trader) -> {
