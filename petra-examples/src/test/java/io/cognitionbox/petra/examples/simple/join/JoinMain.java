...
public class JoinMain extends BaseExecutionModesTest {
     ...
     * This example shows how an separate common A and B can be
     ...
     * In this example there are no steps. All that happens is the input AB is deconstructed into A and B,
