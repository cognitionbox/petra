...
public class TrafficLightsMain extends BaseExecutionModesTest {
    public TrafficLightsMain(ExecMode execMode) {
        super(execMode);
    }
   ...
   public void test() {
       ...
       Lights output = lc.eval(new TrafficLights(), new Lights());

        assertThat(output.isRed());
    }
}
