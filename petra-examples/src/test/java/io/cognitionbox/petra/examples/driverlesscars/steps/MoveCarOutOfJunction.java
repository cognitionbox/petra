...
public class MoveCarOutOfJunction extends PEdge<Simlulation> {
    {
        pre(Simlulation.class,x->x.carsInJunction() && thereExists(Car.class,x.getCars(),c->x.carInJunction(c)));
        func(x->{
        ...
        post(Simlulation.class,x->thereExists(Car.class,x.getCars(),c->!x.carInJunction(c)));
    }
}
